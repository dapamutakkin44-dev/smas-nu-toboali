...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-white font-sans overflow-x-hidden text-slate-900">
        ...
        <div className="container mx-auto flex justify-between items-center px-6">
          <div className="flex items-center gap-2">
            <div className="flex gap-1 bg-white p-1 rounded-full shadow-sm">
              <Image src="/logo-yayasan.png" alt="Logo Yayasan" width={22} height={22} />
              <Image src="/logo-sma.png" alt="Logo SMA" width={22} height={22} />
            </div>
      ...
      {/* 3. HERO SECTION - SKALA FONT DIPERBAIKI */}
      <section className="relative h-[70vh] md:h-[80vh] flex items-center justify-center text-white text-center pt-10">
        <div className="absolute inset-0 z-0">
          <Image src="/gedung-sekolah.jpg" alt="Gedung" fill priority className="object-cover" />
          <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/30 to-[#064E3B]/80"></div>
        </div>
        
        <div className="relative z-10 px-6 max-w-4xl">
          <div className="inline-block px-3 py-1 border border-amber-500 text-amber-400 rounded-full text-[8px] font-bold uppercase mb-6 bg-black/40 backdrop-blur-sm">
            Akreditasi A (UNGGUL)
          </div>
          
          <h2 className="text-4xl md:text-7xl font-black mb-8 leading-[1.1] uppercase italic drop-shadow-2xl text-white">
            Membangun <br/> 
          ...
          <div className="mt-4">
            <Link href="/ppdb" className="inline-block bg-amber-500 text-emerald-900 px-10 py-4 rounded-xl font-black text-sm no-underline uppercase tracking-widest shadow-2xl hover:bg-white transition-all transform hover:scale-105">
      ...
      {/* 4. MENU CEPAT - JARAK PRESISI */}
      <section className="relative z-20 -mt-16 max-w-6xl mx-auto px-4 pb-20">
      ...
      {/* 5. FOOTER - LOGO KEMBALI MUNCUL */}
      <footer className="bg-[#011f18] py-16 text-center border-t-4 border-amber-500 text-white mt-10">
        <div className="flex justify-center gap-6 mb-8 items-center">
          <Image src="/logo-yayasan.png" alt="Logo Yayasan" width={45} height={45} className="object-contain" />
          <div className="w-[1px] h-10 bg-white/20"></div>
          <Image src="/logo-sma.png" alt="Logo SMA" width={45} height={45} className="object-contain" />
        </div>
