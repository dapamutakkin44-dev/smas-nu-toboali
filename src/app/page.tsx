...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] overflow-x-hidden font-sans text-slate-800">
      ...
      {/* 2. RUNNING TEXT - Z-INDEX 40 (TIDAK MENGHALANGI KLIK) */}
      ...
      {/* 3. DRAWER MENU (Garis Tiga) - Z-INDEX 120 */}
      <AnimatePresence>
        {isMenuOpen && (
          <>
            <motion.div 
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-16 text-left">
          ...
          <div className="w-full md:w-1/2">
            <p className="text-emerald-600 font-black uppercase tracking-[0.4em] text-[10px] mb-4 text-left">Message From Principal</p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-auto md:h-[600px]">
            <div className="md:col-span-2 bg-slate-800 rounded-[32px] overflow-hidden relative group h-[300px] md:h-full">
              <img src="/lab.jpg" className="w-full h-full object-cover opacity-60 group-hover:scale-110 group-hover:opacity-100 transition-all duration-700" alt="Lab Komputer" />
              <div className="absolute bottom-8 left-8"><p className="font-black italic text-xl uppercase">Praktikum Lab Komputer</p></div>
            </div>
            <div className="bg-emerald-800 rounded-[32px] overflow-hidden relative group h-[300px] md:h-full">
              ...
              <div className="absolute bottom-8 left-8"><p className="font-black italic text-xl uppercase">Gedung Utama</p></div>
            </div>
            <div className="bg-amber-600 rounded-[32px] overflow-hidden relative group h-[300px] md:h-full">
              ...
              <div className="absolute bottom-8 left-8"><p className="font-black italic text-xl uppercase">Asrama Santri</p></div>
            </div>
            <div className="md:col-span-2 bg-emerald-600 rounded-[32px] overflow-hidden relative group h-[300px] md:h-full">
               ...
               <div className="absolute bottom-8 left-8"><p className="font-black italic text-xl uppercase">Lingkungan Sekolah</p></div>
            </div>
          </div>
        </div>
      </section>
